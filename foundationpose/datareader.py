...
class Ho3dReader:
  ...
  def get_reference_view_1_mesh(self, path):
    obj_list = {
      '019_pitcher_base': f'{path}/019_pitcher_base/final_mesh_019_pitcher_base.obj',
      '010_potted_meat_can': f'{path}/010_potted_meat_can/final_mesh_010_potted_meat_can.obj',
      '021_bleach_cleanser': f'{path}/021_bleach_cleanser/final_mesh_021_bleach_cleanser.obj',
      '006_mustard_bottle': f'{path}/006_mustard_bottle/final_mesh_006_mustard_bottle.obj',
  ...
  def get_reference_K(self, path):
      obj_list = {
        '019_pitcher_base': f'{path}/019_pitcher_base/K.txt',
        '010_potted_meat_can': f'{path}/010_potted_meat_can/K.txt',
        '021_bleach_cleanser': f'{path}/021_bleach_cleanser/K.txt',
        '006_mustard_bottle': f'{path}/006_mustard_bottle/K.txt',
        '003_cracker_box': f'{path}/003_cracker_box/K.txt',
        '004_sugar_box': f'{path}/004_sugar_box/K.txt',
        '005_tomato_soup_can': f'{path}/005_tomato_soup_can/K.txt',
          }
      video_name = obj_list[self.get_video_name_full()]
      return video_name
  ...
  def get_reference_view_1_pose(self, path):
    obj_list = {
      '019_pitcher_base': f'{path}/019_pitcher_base/019_pitcher_base_initial_pose.txt',
      '010_potted_meat_can': f'{path}/010_potted_meat_can/010_potted_meat_can_initial_pose.txt',
      '021_bleach_cleanser': f'{path}/021_bleach_cleanser/021_bleach_cleanser_initial_pose.txt',
      '006_mustard_bottle': f'{path}/006_mustard_bottle/006_mustard_bottle_initial_pose.txt',
      '003_cracker_box': f'{path}/003_cracker_box/003_cracker_box_initial_pose.txt',
      '004_sugar_box': f'{path}/004_sugar_box/004_sugar_box_initial_pose.txt',
      '005_tomato_soup_can': f'{path}/005_tomato_soup_can/005_tomato_soup_can_initial_pose.txt',
      }
    video_name = obj_list[self.get_video_name_full()]
    return video_name

  def get_video_name_full(self):
    video_name = self.get_video_name()
    ob_name = None
    for k in self.video2name:
      if video_name.startswith(k):
        ob_name = self.video2name[k]
        break
    return ob_name
  ...
  def get_obj_id(self):
    ob_id = self.obj_list[self.get_video_name_full()]
    return ob_id
